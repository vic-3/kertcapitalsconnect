import{dJ as w,ef as _,d6 as l,d7 as de,cV as S,cW as L,cZ as b,c_ as v,c$ as d,cY as c,dp as $,dc as D,dq as h,cX as he,d1 as z,cG as m,dm as F,ea as ue,dO as K,cH as M,cO as E,de as X,d4 as pe,cJ as N,eg as T,e7 as Z,dn as me,d3 as ie,eh as fe,e2 as we,cI as be,d8 as ge}from"./index-CyEJwuf1.js";import"./index-BkauZ8SC.js";import{S as ye}from"./SwapController-g-gEY1pK.js";const oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){w.shake();return}if(await _.isSIWXCloseDisabled()){w.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),w.close()}},ve=S`
  :host {
    display: block;
...
`;var G=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const Ce={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let A=class extends v{constructor(){super(...arguments),this.message="",this.type="info"}render(){return d`
    ...
    `}onClose(){D.close()}};A.styles=[L,ke];G([c()],A.prototype,"message",void 0);G([c()],A.prototype,"type",void 0);A=G([b("wui-alertbar")],A);const $e=S`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var I=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const Re=["SmartSessionList"],Oe={PayWithExchange:z.tokens.theme.foregroundPrimary};function J(){const e=l.state.data?.connector?.name,t=l.state.data?.wallet?.name,i=l.state.data?.network?.name,r=t??e,a=X.getConnectors(),o=a.length===1&&a[0]?.id==="w3m-email",n=m.getAccountData()?.socialProvider,s=n?n.charAt(0).toUpperCase()+n.slice(1):"Connect Social";return{Connect:`Connect ${o?"Email":""} Wallet`,Create:"Create Wallet",ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:"All Wallets",ApproveTransaction:"Approve Transaction",BuyInProgress:"Buy",ConnectingExternal:r??"Connect Wallet",ConnectingWalletConnect:r??"WalletConnect",ConnectingWalletConnectBasic:"WalletConnect",ConnectingSiwe:"Sign In",Convert:"Convert",ConvertSelectToken:"Select token",ConvertPreview:"Preview Convert",Downloads:r?`Get ${r}`:"Downloads",EmailLogin:"Email Login",EmailVerifyOtp:"Confirm Email",EmailVerifyDevice:"Register Device",GetWallet:"Get a Wallet",Networks:"Choose Network",OnRampProviders:"Choose Provider",OnRampActivity:"Activity",OnRampTokenSelect:"Select Token",OnRampFiatSelect:"Select Currency",Pay:"How you pay",ProfileWallets:"Wallets",SwitchNetwork:i??"Switch Network",Transactions:"Activity",UnsupportedChain:"Switch Network",UpgradeEmailWallet:"Upgrade Your Wallet",UpdateEmailWallet:"Edit Email",UpdateEmailPrimaryOtp:"Confirm Current Email",UpdateEmailSecondaryOtp:"Confirm New Email",WhatIsABuy:"What is Buy?",RegisterAccountName:"Choose Name",RegisterAccountNameSuccess:"",WalletReceive:"Receive",WalletCompatibleNetworks:"Compatible Networks",Swap:"Swap",SwapSelectToken:"Select Token",SwapPreview:"Preview Swap",WalletSend:"Send",WalletSendPreview:"Review Send",WalletSendSelectToken:"Select Token",WalletSendConfirmed:"Confirmed",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a Wallet?",ConnectWallets:"Connect Wallet",ConnectSocials:"All Socials",ConnectingSocial:s,ConnectingMultiChain:"Select Chain",ConnectingFarcaster:"Farcaster",SwitchActiveChain:"Switch Chain",SmartSessionCreated:void 0,SmartSessionList:"Smart Sessions",SIWXSignMessage:"Sign In",PayLoading:"Payment in Progress",DataCapture:"Profile",DataCaptureOtpConfirm:"Confirm Email",FundWallet:"Fund Wallet",PayWithExchange:"Deposit from Exchange",PayWithExchangeSelectAsset:"Select Asset"}}let y=class extends v{constructor(){super(),this.unsubscribe=[],this.heading=J()[l.state.view],this.network=m.state.activeCaipNetwork,this.networkImage=F.getNetworkImage(this.network),this.showBack=!1,this.prevHistoryLength=1,this.view=l.state.view,this.viewDirection="",this.unsubscribe.push(ue.subscribeNetworkImages(()=>{this.networkImage=F.getNetworkImage(this.network)}),l.subscribeKey("view",t=>{setTimeout(()=>{this.view=t,this.heading=J()[t]},K.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),m.subscribeKey("activeCaipNetwork",t=>{this.network=t,this.networkImage=F.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(t=>t())}render(){const t=Oe[l.state.view]??z.tokens.theme.backgroundPrimary;return this.style.setProperty("--local-header-background-color",t),d`
    ...
    `}onWalletHelp(){M.sendEvent({type:"track",event:"CLICK_WALLET_HELP"}),l.push("WhatIsAWallet")}async onClose(){await oe.safeClose()}rightHeaderTemplate(){const t=E?.state?.features?.smartSessions;return l.state.view!=="Account"||!t?this.closeButtonTemplate():d`<wui-flex>
      <wui-icon-button
        icon="clock"
        size="lg"
        type="neutral"
    ...
    `}leftHeaderTemplate(){const{view:t}=l.state,i=t==="Connect",r=E.state.enableEmbedded,a=t==="ApproveTransaction",o=t==="ConnectingSiwe",n=t==="Account",s=E.state.enableNetworkSwitch,C=a||o||i&&r;return n&&s?d`<wui-select
        id="dynamic"
    ...
    ></wui-icon-button>`}onNetworks(){this.isAllowedNetworkSwitch()&&(M.sendEvent({type:"track",event:"CLICK_NETWORKS"}),l.push("Networks"))}isAllowedNetworkSwitch(){const t=m.getAllRequestedCaipNetworks(),i=t?t.length>1:!1,r=t?.find(({id:a})=>a===this.network?.id);return i||!r}onViewChange(){const{history:t}=l.state;let i=K.VIEW_DIRECTION.Next;t.length<this.prevHistoryLength&&(i=K.VIEW_DIRECTION.Prev),this.prevHistoryLength=t.length,this.viewDirection=i}async onHistoryChange(){const{history:t}=l.state,i=this.shadowRoot?.querySelector("#dynamic");t.length>1&&!this.showBack&&i?(await i.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!0,i.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"})):t.length<=1&&this.showBack&&i&&(await i.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!1,i.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}onGoBack(){l.goBack()}};y.styles=Ne;I([h()],y.prototype,"heading",void 0);I([h()],y.prototype,"network",void 0);I([h()],y.prototype,"networkImage",void 0);I([h()],y.prototype,"showBack",void 0);I([h()],y.prototype,"prevHistoryLength",void 0);I([h()],y.prototype,"view",void 0);I([h()],y.prototype,"viewDirection",void 0);y=I([b("w3m-header")],y);const Ae=S`
  :host {
    display: flex;
    align-items: center;
    gap: ${({spacing:e})=>e[1]};
...
`;var q=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let P=class extends v{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return d`
    ...
    `}templateIcon(){const t={success:"success",error:"error",warning:"warning",info:"default"},i={success:"checkmark",error:"warning",warning:"warningCircle",info:"info"};return this.variant==="loading"?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon-box
      ...
      icon=${i[this.variant]}
    ></wui-icon-box>`}};P.styles=[L,Ae];q([c()],P.prototype,"message",void 0);q([c()],P.prototype,"variant",void 0);P=q([b("wui-snackbar")],P);const Pe=pe`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var ae=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let B=class extends v{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=N.state.open,this.unsubscribe.push(N.subscribeKey("open",t=>{this.open=t,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(t=>t())}render(){const{message:t,variant:i}=N.state;return d` <wui-snackbar message=${t} variant=${i}></wui-snackbar> `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),N.state.autoClose&&(this.timeout=setTimeout(()=>N.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};B.styles=Pe;ae([h()],B.prototype,"open",void 0);B=ae([b("w3m-snackbar")],B);const Te=S`
  :host {
...
`;var x=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const Q="scroll-lock",_e={PayWithExchange:"0",PayWithExchangeSelectAsset:"0"};class g extends v{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=E.state.enableEmbedded,this.open=w.state.open,this.caipAddress=m.state.activeCaipAddress,this.caipNetwork=m.state.activeCaipNetwork,this.shake=w.state.shake,this.filterByNamespace=X.state.filterByNamespace,this.padding=z.spacing[1],this.mobileFullScreen=E.state.enableMobileFullScreen,this.initializeTheming(),T.prefetchAnalyticsConfig(),this.unsubscribe.push(w.subscribeKey("open",t=>t?this.onOpen():this.onClose()),w.subscribeKey("shake",t=>this.shake=t),m.subscribeKey("activeCaipNetwork",t=>this.onNewNetwork(t)),m.subscribeKey("activeCaipAddress",t=>this.onNewAddress(t)),E.subscribeKey("enableEmbedded",t=>this.enableEmbedded=t),X.subscribeKey("filterByNamespace",t=>{this.filterByNamespace!==t&&!m.getAccountData(t)?.caipAddress&&(T.fetchRecommendedWallets(),this.filterByNamespace=t)}),l.subscribeKey("view",()=>{this.dataset.border=Z.hasFooter()?"true":"false",this.padding=_e[l.state.view]??z.spacing[1]}))}firstUpdated(){if(this.dataset.border=Z.hasFooter()?"true":"false",this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),this.caipAddress){if(this.enableEmbedded){w.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(t=>t()),this.onRemoveKeyboardListener()}render(){return this.style.setProperty("--local-modal-padding",this.padding),this.enableEmbedded?d`${this.contentTemplate()}
    ...
    </wui-card>`}async onOverlayClick(t){if(t.target===t.currentTarget){if(this.mobileFullScreen)return;await this.handleClose()}}async handleClose(){await oe.safeClose()}initializeTheming(){const{themeVariables:t,themeMode:i}=me.state,r=ie.getColorTheme(i);fe(t,r)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),N.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const t=document.createElement("style");t.dataset.w3m=Q,t.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
    ...
    `,document.head.appendChild(t)}onScrollUnlock(){const t=document.head.querySelector(`style[data-w3m="${Q}"]`);t&&t.remove()}onAddKeyboardListener(){this.abortController=new AbortController;const t=this.shadowRoot?.querySelector("wui-card");t?.focus(),window.addEventListener("keydown",i=>{if(i.key==="Escape")this.handleClose();else if(i.key==="Tab"){const{tagName:r}=i.target;r&&!r.includes("W3M-")&&!r.includes("WUI-")&&t?.focus()}},this.abortController)}onRemoveKeyboardListener(){this.abortController?.abort(),this.abortController=void 0}async onNewAddress(t){const i=m.state.isSwitchingNamespace,r=l.state.view==="ProfileWallets";t?await this.onConnected({caipAddress:t,isSwitchingNamespace:i,isInProfileView:r}):!i&&!this.enableEmbedded&&!r&&w.close(),await _.initializeIfEnabled(t),this.caipAddress=t,m.setIsSwitchingNamespace(!1)}async onConnected(t){if(t.isInProfileView)return;const{chainNamespace:i,chainId:r,address:a}=we.parseCaipAddress(t.caipAddress),o=`${i}:${r}`,n=!be.getPlainAddress(this.caipAddress),s=await _.getSessions({address:a,caipNetworkId:o}),C=_.getSIWX()?s.some(U=>U.data.accountAddress===a):!0,V=t.isSwitchingNamespace&&C&&!this.enableEmbedded,j=this.enableEmbedded&&n;V?l.goBack():j&&w.close()}onNewNetwork(t){const i=this.caipNetwork,r=i?.caipNetworkId?.toString(),a=i?.chainNamespace,o=t?.caipNetworkId?.toString(),n=t?.chainNamespace,s=r!==o,V=s&&!(a!==n),j=i?.name===ge.UNSUPPORTED_NETWORK_NAME,U=l.state.view==="ConnectingExternal",ne=l.state.view==="ProfileWallets",se=!m.getAccountData(t?.chainNamespace)?.caipAddress,le=l.state.view==="UnsupportedChain",ce=w.state.open;let O=!1;this.enableEmbedded&&l.state.view==="SwitchNetwork"&&(O=!0),s&&ye.resetState(),ce&&!U&&!ne&&(se?s&&(O=!0):(le||V&&!j)&&(O=!0)),O&&l.state.view!=="SIWXSignMessage"&&l.goBack(),this.caipNetwork=t}prefetch(){this.hasPrefetched||(T.prefetch(),T.fetchWalletsByPage({page:1}),this.hasPrefetched=!0)}}g.styles=Te;x([c({type:Boolean})],g.prototype,"enableEmbedded",void 0);x([h()],g.prototype,"open",void 0);x([h()],g.prototype,"caipAddress",void 0);x([h()],g.prototype,"caipNetwork",void 0);x([h()],g.prototype,"shake",void 0);x([h()],g.prototype,"filterByNamespace",void 0);x([h()],g.prototype,"padding",void 0);x([h()],g.prototype,"mobileFullScreen",void 0);let ee=class extends g{};ee=x([b("w3m-modal")],ee);let te=class extends g{};te=x([b("appkit-modal")],te);const De=S`
  :host {
    width: 100%;
  }
`;var p=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let u=class extends v{constructor(){super(...arguments),this.hasImpressionSent=!1,this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100",this.rdnsId="",this.walletRank=void 0}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.cleanupIntersectionObserver()}updated(t){super.updated(t),(t.has("name")||t.has("imageSrc")||t.has("walletRank"))&&(this.hasImpressionSent=!1),t.has("walletRank")&&this.walletRank&&!this.intersectionObserver&&this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver=new IntersectionObserver(t=>{t.forEach(i=>{i.isIntersecting&&!this.loading&&!this.hasImpressionSent&&this.sendImpressionEvent()})},{threshold:.1}),this.intersectionObserver.observe(this)}cleanupIntersectionObserver(){this.intersectionObserver&&(this.intersectionObserver.disconnect(),this.intersectionObserver=void 0)}sendImpressionEvent(){!this.name||this.hasImpressionSent||!this.walletRank||(this.hasImpressionSent=!0,(this.rdnsId||this.name)&&M.sendEvent({type:"track",event:"WALLET_IMPRESSION",properties:{name:this.name,walletRank:this.walletRank,rdnsId:this.rdnsId,view:l.state.view}}))}render(){return d`
      <wui-list-wallet
