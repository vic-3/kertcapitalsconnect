...
`;var E=function(n,e,a,s){var r=arguments.length,o=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,a):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,a,s);else for(var p=n.length-1;p>=0;p--)(u=n[p])&&(o=(r<3?u(o):r>3?u(e,a,o):u(e,a))||o);return r>3&&o&&Object.defineProperty(e,a,o),o};let y=class extends F{constructor(){super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=l.state.exchanges,this.isLoading=l.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=d.getAccountData()?.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(l.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(l.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(d.subscribeChainProp("accountState",e=>{this.connectedWalletInfo=e?.connectedWalletInfo})),l.fetchExchanges()}get isWalletConnected(){return d.getAccountData()?.status==="connected"}render(){return m`
...
`;var U=function(n,e,a,s){var r=arguments.length,o=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,a):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,a,s);else for(var p=n.length-1;p>=0;p--)(u=n[p])&&(o=(r<3?u(o):r>3?u(e,a,o):u(e,a))||o);return r>3&&o&&Object.defineProperty(e,a,o),o};const me=4e3;let N=class extends F{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=l.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return m`
      <wui-flex
