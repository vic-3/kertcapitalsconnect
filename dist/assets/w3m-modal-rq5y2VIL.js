import{dJ as w,ef as _,d6 as l,d7 as de,cV as S,cW as L,cZ as b,c_ as v,c$ as d,cY as c,dp as $,dc as D,dq as h,cX as he,d1 as z,cG as m,dm as F,ea as ue,dO as K,cH as M,cO as E,de as X,d4 as pe,cJ as N,eg as T,e7 as Z,dn as me,d3 as ie,eh as fe,e2 as we,cI as be,d8 as ge}from"./index-zc00MnbT.js";import"./index-Bav14Zci.js";import{S as ye}from"./SwapController-_4Mv0wzW.js";const oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){w.shake();return}if(await _.isSIWXCloseDisabled()){w.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),w.close()}},ve=S`
  :host {
    display: block;
