import{cG as S,d7 as _,cO as p,cH as c,d6 as s,dJ as g,cJ as f,cI as C,cZ as u,cV as D,c_ as y,de as d,c$ as m,dq as E,d4 as $,d0 as W,d2 as N,dK as P,d8 as T}from"./index-CyEJwuf1.js";import{W as b}from"./index-CcyPUNuE.js";var U=function(r,e,t,a){var n=arguments.length,i=n<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,t):a,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,e,t,a);else for(var l=r.length-1;l>=0;l--)(o=r[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){const t=S.state.activeChain,a=_.getConnections(t),n=p.state.remoteFeatures?.multiWallet,i=a.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await _.connectExternal(this.authConnector,t);else throw new Error("Active chain is not set on ChainControll");if(c.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"email",name:this.authConnector.name||"Unknown",view:s.state.view,walletRank:void 0}}),p.state.remoteFeatures?.emailCapture)return;if(p.state.siwx){g.close();return}if(i&&n){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}g.close()}}catch(t){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=U([u("w3m-email-verify-otp-view")],I);const F=D`
  wui-icon-box {
